...
const Skills = () => {
    return (
        <div className='my-16 space-y-6'>
            ...
            <div className='grid grid-cols-2 md:grid-cols-3 gap-6 mx-auto md:w-3/4'>  
                <div className='bg-zinc-900 py-8 rounded-xl flex flex-col items-center justify-center space-y-3'>
                ...
                <div className='bg-zinc-900 md:hidden py-8 rounded-xl flex flex-col items-center justify-center space-y-3'>
                    <img className='w-[80px]' src={cLang} alt="" />
                    <p className='font-semibold text-white'>C programming</p>
                </div> 
               
            </div>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6 mx-auto w-1/2'> 
                <div className='bg-zinc-900 hidden md:visible  py-8 rounded-xl md:flex flex-col items-center justify-center space-y-3'>
                    <img className='w-[80px]' src={cLang} alt="" />
                    <p className='font-semibold text-white'>C programming</p>
                </div>  
                <div className='bg-zinc-900 py-8 rounded-xl flex flex-col items-center justify-center space-y-3'>
